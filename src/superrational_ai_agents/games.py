...
PLAYERS_SETUP_TEXT = {
    ...
    PlayersVariant.DIFF_MODEL_SIMILARLY_RATIONAL: "You will be playing against other similarly rational AI agents.",
    PlayersVariant.DIFF_MODEL_OTHER_AGENTS: "You will be playing against other AI agents.",
